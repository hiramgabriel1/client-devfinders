...
<section class="border-t">
    <div class="container mx-auto flex flex-row lg:flex-row lg:space-x-6">
        <main class="w-full md:border-r md:px-3 lg:border-r lg:pb-6">
            <div
                class="flex flex-wrap py-6 lg:justify-between sm:justify-between"
            >
                <div class="font-secondary flex flex-wrap text-sm space-x-3">
                    <div class="">
                        <button class="hover:font-bold hover:border-b"
                            >Para ti</button
                        >
                    </div>
                    <div>
            ...
            <div>
                ...
                <div class="font-secondary py-4">
                    <h1 class="font-bold text-xl">
                        Demystifying Blockchain: Was it intentionally made
                        confusing?
                    </h1>
                    <p class="py-2 text-xs lg:pr-6">
                        For many, the concept of blockchain can seem perplexing
                        and shrouded in mystery. Its intricate technical
                        aspects, complex terminologies, and abstract
                        explanations have left even the most seasoned
                        individuals scratching their heads. It's as if the
                ...
                <div class="lg:flex lg:justify-between lg:pr-7">
                    <div>
                        <div class="flex text-xs space-x-2">
                            <div class="w-14">
                                <span class="border rounded-full px-2"
                                    >Popular</span
                                >
                            </div>
                            <div class="w-15">
        ...
        >
            ...
            <div class="border-b">
                ...
                <div class="font-secondary text-sm flex flex-wrap gap-3">
                    <button
                        class="rounded-full bg-slate-200 py-1 px-2 hover:bg-slate-300"
