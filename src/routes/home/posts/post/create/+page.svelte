<script>
    ...
    import create_2 from "$lib/public/images/create_2.png";
...
<section>
    ...
    <div class="container xl:px-[12rem] lg:my-4 sm:my-10 lg:w-[85%]">
        <div class="font-secondary flex justify-between py-8">
            ...
            <div>
                <button
                    ...
                    ><img src={view_2} alt="view" class="mr-1" />Preview</button
                >
            </div>
        </div>
        ...
        <div class="flex justify-center pb-2 flex-col">
            <div
                class="border border-gray-300 rounded-md border-dashed px-3 py-3 flex justify-center lg:py-12 md:py-10"
            >
                <div>
        ...
        <form>
            <div class="font-secondary py-4">
                <div class="flex">
                    ...
                    <span class="text-red-500 font-semibold text-lg pl-1"
                        >*</span
                    >
                </div>
                <div class="pb-2">
                    <span class="text-sm text-gray-600"
                        >Agrega un titulo para distinguirte de otras
                        publicaciones</span
                    >
                </div>
            ...
            <div class="font-secondary py-6">
                ...
                <div class="flex h-auto">
                    <div class="w-full">
                        <textarea
                            class="w-full py-12 rounded-lg bg-gray-200 h-[100%]"
                        ></textarea>
                    </div>
                    <div class="flex-col pt-2 items-center">
                        <div class="pl-2">
                            <button
                                ><img src={h} alt="H" class="w-5 h-5" /></button
                            >
                        </div>
                        <div class="pl-2">
            ...
            <div class="font-secondary my-6 border-b-2">
                <div class="py-4">
                    ...
                    <div class="pb-2">
                        <span class="text-sm text-gray-600"
                            >Permite que los usuarios puedan compartir tu
                            publicación con otras personas</span
                        >
                    </div>
                </div>
                ...
                <div class="py-4">
                    ...
                    <div class="pb-2">
                        <span class="text-sm text-gray-600"
                            >Permite que los usuarios puedan ver la cantidad de
                            likes que tiene tu publicación</span
                        >
                    </div>
                </div>
                ...
                <div class="py-4">
                    ...
                    <div class="pb-2">
                        <span class="text-sm text-gray-600"
                            >Duis consectetur adipisicing irure anim incididunt
                            ex Lorem ullamco fugiat</span
                        >
                    </div>
                </div>
            ...
            <div class="font-secondary my-6 border-b-2">
                ...
                <div>
                    ...
                    <div class="pb-2">
                        <span class="text-sm text-gray-600"
                            >Puedes aumentar las visitas a tu publicacion y
                            ponerla en primera vista</span
                        >
                    </div>
