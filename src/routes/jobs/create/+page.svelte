...
<section>
    <div class=" py-8 mx-auto">
        ...
        <div class="container flex place-content-around py-8">
            ...
            >
                <h2 class="font-secondary font-bold text-xl">
                    Project Information
                </h2>
                <div class="py-8">
                ...
                <div class="flex flex-col md:flex-row gap-2">
                    ...
                    <div class="w-full">
                        ...
                        <input
                            class="block bg-slate-200 rounded w-full focus:border-color-blue-highlight px-4"
                        />
                    </div>
                </div>
                ...
                >
                    <p>
                        This is how candidate figures out what you need and why
                        you're great to work with
                    </p>
                </div>
                <div class="flex flex-row-reverse py-4">
                    <select
                        class="font-secondary text-color-blue-highlight text-s"
                    >
